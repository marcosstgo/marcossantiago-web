...
out = ['/* Font Awesome 6.5 Free — subset: solo los iconos usados en el sitio.',
       '   Generado con scripts/generar-fa-subset.py a partir de all.min.css.',
       '   Las .woff2 estan self-hosted en public/fonts/ y SUBSETEADAS (solo los',
       '   glifos usados). Al usar un icono nuevo hay que: (1) regenerar este CSS',
       '   y (2) re-subsetear la .woff2 con pyftsubset usando los nuevos codepoints,',
       '   si no el glifo saldra invisible. font-display: swap para no bloquear. */',
       '@font-face {',
