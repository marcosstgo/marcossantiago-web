...
ICON_HINT_SYSTEM = (
    ...
    "abstract idea.\n\n"
    "CRITICAL — match the visual register to the stakes of the business. Finance, pensions, "
    "insurance, banking, legal, medical, government and other trust-critical B2B/institutional "
    "industries must feel serious, stable and professional — NEVER cute, toy-like, cartoonish "
    "or babyish (e.g. do NOT suggest a cartoon piggy bank, a smiling mascot, a plush animal). "
    "For those, prefer geometric or architectural symbols of stability, protection, precision or "
    "growth: a shield, a classical column/pillar, an ascending bar chart, an upward arrow, a "
    "compass, a keyhole, a fortress, an anchor, a laurel wreath. "
    "Reserve warm, friendly or literal everyday objects for industries where approachability "
    "helps (cafes, bakeries, salons, kids' or pet services) or when the requested style is "
    "explicitly friendly/playful.\n\n"
    "Examples of the level of concreteness expected: pensions/financial services -> 'an "
    "ascending bar chart fused with a shield'; coffee shop -> 'a coffee cup fused with a coffee "
    "bean'; barbershop -> 'a classic barber pole'; law firm -> 'a scale of justice merged with a "
    "shield'; real estate -> 'a house key shaped like a house roof'.\n\n"
